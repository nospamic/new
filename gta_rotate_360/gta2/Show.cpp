...
void Show::printScreen(int xPosition, int yPosition, float xSpeed, int ySpeed, int *roadArray)
{
	int pixel;
	resetScreen();
	...
	rotate.rotateArray(expScreenSizeX,expScreenSizeY,xPosition,0,&expandedScreen[0],xSpeed*180/pi);
